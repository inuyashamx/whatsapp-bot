    ...
    const positions = await Promise.all([
        prisma.jobPosition.upsert({
            ...
            create: {
                ...
                description: 'We are looking for a Senior Backend Developer to join our growing engineering team. You will be responsible for designing, developing, and maintaining scalable backend services.',
                requirements: [
        ...
        prisma.jobPosition.upsert({
            ...
            create: {
                ...
                department: 'Product',
                description: 'We are seeking a Product Manager to help define and execute our product strategy. You will work closely with engineering, design, and business teams.',
                requirements: [
        ...
        prisma.jobPosition.upsert({
            ...
            create: {
                ...
                department: 'Engineering',
                description: 'Join our team as a Frontend Developer to build beautiful, responsive web applications. You will work on our customer-facing products using modern technologies.',
                requirements: [
